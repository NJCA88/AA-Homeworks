...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
        expect { Dessert.new('ice_cream', 'ALL', chef) }.to raise_error
  end
end
  ...
  describe "#mix!" do
    ...
    ingredients = ['flour', 'chocolate', 'people', 'eggs', 'cream']
    cake.mix!
    expect(ingredients).not_to eq(ingredients.sort)
  end
  ...
  describe "#serve" do
    ...
    expect(cake.serve).to eq("Chef Tucker the Great Baker has made 100 cakes!")
  end
end
